...
export const CinderellaStoryContentInSinhala = [
  { imageId: cinderellaStoryImages.cinderellaImage1, passageId: 1 },
];
...
export const CinderellaStoryContent = [
  {
    ...
    questionBank: {
      ...
      medium: [
        {
          questionId: 1,
          question: "ඇයි සින්ඩරෙල්ලාට එයාගේ ලොකු ගෙදර හැම වැඩක්ම කරන්න වෙන්නේ?",
          options: [
        ...
        {
          questionId: 5,
          question: "කතාවේදී සින්ඩරෙල්ලාගේ සුළු සහෝදරියන් ඇයට සලකන්නේ කෙසේද?",
          options: [
  ...
  },
  {
    ...
    questionBank: {
      easy: [
        ...
        {
          questionId: 3,
          question: "සුරංගනාවිය සින්ඩරෙල්ලාගේ සරල ඇඳුම් බවට පත් කළේ කුමක්ද?",
          options: ["විශිෂ්ට ගවුමක්", "වට්ටක්කා", "දිළිසෙන සැරයටියක්", "මලක්"],
  ...
  },
  {
    ...
    questionBank: {
      ...
      medium: [
        ...
        {
          questionId: 3,
          question: "විවාහයෙන් පසු සින්ඩරෙල්ලා සහ කුමාරයා ජීවත් වූයේ කෙසේද?",
          options: [
            "සදහටම සතුටින්",
            "අසතුටුදායකයි",
            "වට්ටක්කා ගෙඩියක",
    ...
    questionBank: {
      ...
      medium: [
        ...
        },
        {
          ...
          options: ["Sang songs", "Lowered hair", "Used magic", "Flew to him"],
          correctAnswer: "Lowered hair",
        },
      ],
      hard: [],
    ...
    questionBank: {
      easy: [
        ...
        },
        {
          ...
          options: ["Broke it", "Made it stronger", "Changed it", "Nothing"],
    ...
    questionBank: {
      easy: [
        ...
        },
        {
          ...
          options: ["In ancient Greece", "In Rome", "In Egypt", "In Persia"],
      ...
      medium: [
        {
          ...
          correctAnswer: "Because he was the son of Zeus, the king of the gods",
        },
        {
          questionId: 2,
      ...
      medium: [
        {
          ...
          correctAnswer: "Because he was incredibly strong and didn't know why",
        },
        {
          questionId: 2,
        ...
        {
          questionId: 3,
          question: "How did Hercules feel compared to others in his village?",
          options: [
            "He felt different",
            "He felt the same",
            "He felt superior",
  ...
  },
  {
    ...
    questionBank: {
      ...
      medium: [
        ...
        {
          questionId: 4,
          question: "What important lessons did Hercules learn on his journey?",
          options: [
  ...
  },
  {
    ...
    questionBank: {
      easy: [
        ...
        {
          questionId: 5,
          question: "Did Hercules become a hero in the eyes of all of Greece?",
          options: ["Yes", "No"],
          correctAnswer: "Yes",
        },
      ],
      medium: [
        ...
        {
          questionId: 2,
          question: "What happened to the evil sorceress who had tricked him?",
          options: [
